...
update_status ModulePlayer::Update()
{
	...
	{
		App->particles->AddParticle(App->particles->shot, position.x + 45, position.y);
		//App->particles->AddParticle(App->particles->shot, position.x - 25, position.y, 500);
		//App->particles->AddParticle(App->particles->shot, position.x, position.y - 25, 1000);
		//App->particles->AddParticle(App->particles->shot, position.x + 25, position.y, 1500);
	}
